(function() {
    ...
    class Box extends HTMLElement {
        ...
        svg_circle_arc_path(x, y, radius, start_angle, end_angle)
        {
            ...
            return "M " + start_xy[0] + " " + start_xy[1] + "A " + radius + " " + radius + "0 0 0 " + end_xyz[0]+ " " +end_xy[1];
        }
