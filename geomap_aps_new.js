(function () {
      ...
      <form id="form" autocomplete="off">
        <fieldset> 
          ...
          <table>
            ...
            <tr>
              <td><label for="sceneID">Scene ID:</label></td>
              <td><input id="sceneID" name="sceneID" type="text"></td>
            </tr>
          </table>
        </fieldset>
    ...
    class restAPIAps extends HTMLElement {
        ...
        get sceneID() {
            return this.getValue("sceneID");
        }
        set sceneID(value) {
            this.setValue("sceneID", value);    
        }
    ...
    customElements.define("com-sap-custom-geomap-aps-new", restAPIAps);
})();